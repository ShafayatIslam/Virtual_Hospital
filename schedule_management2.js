...
let locationsArray = [
    // Ei gula sample location data - page load hole egula render hoy
    {
        ...
        slots: [
            { id: 101, startTime: "10:00", endTime: "11:00", maxPatients: 10, days: ["Mon", "Wed", "Fri"] },
            { id: 102, startTime: "10:00:00", endTime: "11:00:00", maxPatients: 10, days: ["Mon", "Wed", "Fri"] },
            { id: 103, startTime: "19:00", endTime: "21:00", maxPatients: 8, days: ["Tue", "Thu"] }
        ]
    },
    {
        id: 2,
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (locationsContainer) {
        locationsContainer.addEventListener("click", (e) => {
            ...
            const isEditBtn = e.target.closest(".btn-edit-loc");
            
            if (locHeader && !isDeleteBtn && !isEditBtn) {
                ...
                <div class="time-slot-card" data-slot-id="${slot.id}">
                    <div class="slot-inputs">
                        <div class="form-group">
                            ...
                            <div class="time-input-grp">
                                <div class="time">
                                    <p>Start Time: </p><input type="time" class="input-time" value="${slot.startTime}" placeholder="Start Time">
                                </div>
                                <div class="time">
                                    <p>End Time: </p><input type="time" class="input-time" value="${slot.endTime}" placeholder="End Time">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="slot-footer">
                        ...
                        <div class="slot-btn-grp">
                            <button type="button" class="btn-edit-icon btn-edit-slot" data-slot-id="${slot.id}">
            ...
            <div class="location-card ${isExpandedClass}" data-id="${loc.id}">
                <div class="loc-header">
                    ...
                    <div class="loc-btn-grp">
                        <button type="button" class="btn-edit-icon btn-edit-loc">
                            <i class="fa-solid fa-pen-to-square"></i>
                        </button>
